...
interface QuizTabProps {
    ...
    onCorrectAnswer: () => void; // New prop for notifying correct answer
}

const QuizTab = ({ question, answers, correctAnswerIndex, onCorrectAnswer }: QuizTabProps) => {
    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-black bg-opacity-70 font-pixel">
            <div className="bg-gray-900 p-6 rounded-xl shadow-xl text-white w-96">
